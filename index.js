...
module.exports = () => {
  const rules = {
    ...
    currency: [
      ...
      ({ htmlDom: $, url }) => JSON.parse($(".twister-plus-buying-options-price-data").html())?.desktop_buybox_group_1[0].currencySymbol,
    ],
    condition: [
    ...
    price: [
      ...
      ({ htmlDom: $, url }) => JSON.parse($(".twister-plus-buying-options-price-data").html())?.desktop_buybox_group_1[0].priceAmount,
      ({ htmlDom: $, url }) =>
        toPriceFormat(
